/*
 ...
 CHANGE HISTORY
  4.1 Added sound at the start of program, optimized ManualTestServo(),
      trimemd some delay at the program start
  4.0 Initial english release
 * ---------------------------------------------------------------
 * ------------------------- CONNECTIONS -------------------------
 * ---------------------------------------------------------------
 * PIN Arduino NANO   
...
unsigned long time;
  ...
  pot=GetRvarPosition();          // Get potentiometer position
